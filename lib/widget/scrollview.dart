...
typedef BaseScrollViewItemType = Widget? Function(BuildContext context, int index);
typedef BaseScrollViewBuilder = Widget Function(BuildContext context, int index);
